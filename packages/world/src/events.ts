...
export interface EventResult {
  ...
  /**
   * All events up to this point, with data resolved. Only populated on
   * run_started 200 responses where we are the first caller — used to
   * skip the initial events.list call and reduce TTFB.
   */
  events?: Event[];
}
