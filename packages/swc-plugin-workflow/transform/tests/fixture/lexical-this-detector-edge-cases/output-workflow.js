...
export class Edge {
    ...
    withThisInDefaultParam() {
        return {
            execute: globalThis[Symbol.for("WORKFLOW_USE_STEP")]("step//./input//_anonymousStep0").bind(this)
        };
    }
    ...
    withClassBodyOnly() {
        return {
            execute: globalThis[Symbol.for("WORKFLOW_USE_STEP")]("step//./input//_anonymousStep1")
        };
    }
}
