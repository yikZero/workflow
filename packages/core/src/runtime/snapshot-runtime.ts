...
// Read the VM serde bundle from disk. This is a self-contained IIFE
// generated by scripts/build-vm-serde-bundle.js that sets up
// serialize/deserialize + polyfills inside the QuickJS VM.
// Reading from a file avoids escaping issues that arise when embedding
// JS source inside a JS string literal (which breaks downstream esbuild).
const __dirname = dirname(fileURLToPath(import.meta.url));
const VM_SERDE_BUNDLE = readFileSync(
  resolve(__dirname, 'vm-serde-bundle.generated.js'),
  'utf-8'
);
