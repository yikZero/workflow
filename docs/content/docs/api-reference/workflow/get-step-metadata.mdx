...
> See the full API reference for [`getStepMetadata`](/docs/api-reference/workflow/api/functions/getStepMetadata).

### Returns

> See the full API reference for [`StepMetadata`](/docs/api-reference/workflow/api/interfaces/StepMetadata).
