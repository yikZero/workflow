...
description: Access run IDs and timing information within workflow or step functions.
type: reference
summary: Call getWorkflowMetadata inside a workflow or step function to access the run ID and timing information.
prerequisites:
