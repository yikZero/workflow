...
> See the full API reference for [`getWorkflowMetadata`](/docs/api-reference/workflow/api/functions/getWorkflowMetadata).

### Returns

> See the full API reference for [`WorkflowMetadata`](/docs/api-reference/workflow/api/interfaces/WorkflowMetadata).
