...
<Cards>
    ...
    <Card href="/docs/api-reference/workflow/set-attribute" title="setAttribute()">
        Tag a run with a single key-value attribute for observability and filtering.
    </Card>
    <Card href="/docs/api-reference/workflow/set-attributes" title="setAttributes()">
        Tag a run with multiple attributes in a single batched event.
    </Card>
    <Card href="/docs/api-reference/workflow/get-attribute" title="getAttribute()">
        Read a single attribute from the current run.
    </Card>
    <Card href="/docs/api-reference/workflow/get-attributes" title="getAttributes()">
        Read the full attribute snapshot for the current run.
    </Card>
</Cards>
