...
> See the full API reference for [`defineHook`](/docs/api-reference/workflow/api/functions/defineHook).

### Returns

> See the full API reference for [`TypedHook`](/docs/api-reference/workflow/api/interfaces/TypedHook).
