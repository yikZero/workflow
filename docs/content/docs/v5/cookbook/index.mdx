...
- [**Resume or start by hook token**](/cookbook/common-patterns/resume-or-start) — Look up an existing run via `getHookByToken` before `start()`, and understand the concurrency limits
