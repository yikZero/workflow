---
title: Idempotency
description: Use step IDs for retry-safe side effects and hook tokens to coordinate duplicate workflow starts.
type: conceptual
summary: Make step side effects retry-safe with step IDs, and route duplicate workflow-start requests through deterministic hook tokens.
prerequisites:
