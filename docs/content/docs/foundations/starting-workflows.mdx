...
<Callout type="info">
Starting child workflows from inside workflow functions is currently available in Workflow v5 only. Keep this guidance behind the docs version switcher and do not backport it into earlier versions.
</Callout>
