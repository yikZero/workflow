...
Add the `"use workflow"` directive and wrap the streaming call inside a step function. The step becomes a durable unit of execution that Workflow can retry and observe.
