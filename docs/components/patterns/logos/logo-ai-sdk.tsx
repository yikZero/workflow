/**
 * AI SDK wordmark — ported from the canonical `AISDKLogo` in
 * https://github.com/vercel/ai
 * (packages/devtools/src/viewer/client/components/icons.tsx).
 *
 * The mark is a horizontal wordmark (`AI` + a pill-shaped `SDK` badge),
 * so its rendered width is derived from its viewBox aspect ratio rather
 * than the `size` prop directly. `size` here means *height* in px.
 *
 * All paths and strokes use `currentColor` so the logo inherits text
 * color and adapts to light/dark themes automatically.
 */
